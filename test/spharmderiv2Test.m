...
function test_suite = spharmderiv2Test
    initTestSuite;
end
...
assertEqual(size(d11), [n, 2*Ns + 1]);
assertEqual(size(d12), [n, 2*Ns + 1]);
assertEqual(size(d21), [n, 2*Ns + 1]);
assertEqual(size(d22), [n, 2*Ns + 1]);
