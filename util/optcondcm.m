...
function [dim, A, D, E, G, b] = optcondcm(Ns, cs1, cs2, dt, X, k, h, xi, w, gradf, dtdf, f, s, mem)
...
%
%   [dim, A, D, E, G, b] = OPTCONDCM(Ns, cs1, cs2, dt, X, k, h, xi, w, gradf, dtdf, f, s) 
%   takes degrees Ns and Fourier coefficients cs1, cs2 of the surface, a
%   temporal scaling parameter dt, center points X of basis functions, 
%   degree k, a scaling factor h, quadrature rule [xi, w], and  gradient 
%   gradf of data, temporal derivative dtdf, data f, and a segmentation s, 
%   and returns the linear system representing the optimality conditions.
%
%   [dim, A, D, E, G, b] = OPTCONDCM(Ns, cs1, cs2, dt, X, k, h, xi, w, gradf, dtdf, f, s, mem)
